...
class ContactsVO {
  ...
  ContactsVO({@required this.sectionKey, @required  this.name, @required this.avatarUrl});
  
}

//好友数据集
List<ContactsVO> contactsData = [
  new ContactsVO(
    sectionKey: 'A',
    name: 'A张三',
  ...
  new ContactsVO(
    ...
    avatarUrl:
    ''),
  new ContactsVO(sectionKey: 'L', name: '联通', avatarUrl: ''),
  new ContactsVO(
    sectionKey: 'L',
    name: '留学生',
  ...
  new ContactsVO(
    ...
    avatarUrl:
    ''),
  new ContactsVO(sectionKey: 'M', name: 'Mary', avatarUrl: ''),
  new ContactsVO(
    sectionKey: 'M',
    name: 'Master',
    avatarUrl:
    ''),
  new ContactsVO(sectionKey: 'P', name: '彭于晏', avatarUrl: ''),
  new ContactsVO(
    sectionKey: 'P',
    name: '彭简',
    avatarUrl:
  ...
  new ContactsVO(sectionKey: 'S', name: '孙丽', avatarUrl: ''),
  new ContactsVO(
    sectionKey: 'S',
    name: '沈家',
    avatarUrl:
  ...
  new ContactsVO(sectionKey: 'X', name: '小猪', avatarUrl: ''),
  new ContactsVO(
    sectionKey: 'X',
    name: '小猪佩奇',
    avatarUrl:
